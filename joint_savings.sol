...
contract JointSavings {
    ...
    */
    // Default fallback function to handle Ether sent to the contract without a specific function being called.
function() external payable {
    // Optionally, you can add custom logic here if needed.
    // In this example, we'll simply update the contract balance.
    contractBalance = address(this).balance;
}
}
